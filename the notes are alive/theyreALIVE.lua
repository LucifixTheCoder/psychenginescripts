...
function onCreatePost()
  ...
  for i=1,4 do
    ...
    notes[i] = {
      ...
      setProperty = function(self, who, what)
        setPropertyFromGroup('strumLineNotes', i-1, who, what)
      end,
      getProperty = function(self, who)
...
whatToDo = {
  ...
  [movement.MOVING] = function(note)
    local meAngle = ((note:getProperty'angle' + note.angleOffset) % 360) * math.pi/180
